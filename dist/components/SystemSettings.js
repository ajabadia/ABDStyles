...
export function SystemSettings({ locale, onLocaleChange, locales = ["es", "en"], theme, onThemeChange, translations, isAuthenticated = false, onLogin, onLogout, logoutUrl = "/api/auth/logout", signinUrl = "/api/auth/signin", showLogin = true, versionSignature = "ABD_SYSTEM_V1.0", }) {
