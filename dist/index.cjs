...
function RoleBadge({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "span",
    {
      ...
      children: [
        showIcon && variant === "default" && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "relative flex h-2 w-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: `animate-ping absolute inline-flex h-full w-full rounded-full ${visual.badgeBg} opacity-75` }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: `relative inline-flex rounded-full h-2 w-2 ${visual.badgeBg}` })
        ] }),
        showIcon && variant !== "default" && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "shrink-0 flex items-center", children: /* @__PURE__ */ jsxRuntime.jsx(IconComponent, { size: 12, "aria-hidden": "true" }) }),
        label
      ]
    }
  );
